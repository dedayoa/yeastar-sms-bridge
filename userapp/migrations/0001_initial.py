    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('messages_backup_recipients', models.ManyToManyField(blank=True, help_text='message backup recipient(s)', related_name='backup_recipients', to='userapp.Contact')),
                ('notification_contacts', models.ManyToManyField(blank=True, help_text='general notification recipient(s)', to='userapp.Contact')),
